...
## Code Comments
Comments are not not governance artifacts. They may, however, shape agent behavior with similar impact as governance artifacts, or otherwise dilute contexts.

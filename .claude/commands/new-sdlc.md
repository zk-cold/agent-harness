...
The mission must be self-contained: a critic with access to only the harness repo-root `.agent/schemas/governance-schema.md`, the harness repo-root `CLAUDE.md`, the harness repo-root `.agent/schemas/critic-protocol.md`, the harness repo-root `.agent/schemas/mission-schema.md`, and `mission.md` must be able to evaluate it.

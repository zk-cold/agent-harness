...
**Outputs:** Implementation (code changes in worktree), passing full regression suite, touched code remains above the >80% coverage threshold, clean formatter/linter results.
